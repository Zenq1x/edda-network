...
import { Connection, Keypair, SystemProgram, Transaction, LAMPORTS_PER_EDDA } from './index';
...
async function main() {
  ...
  console.log('Supply     :', info.total_supply / LAMPORTS_PER_EDDA, 'EDDA');
  ...
  tx.add(SystemProgram.transfer({
    ...
    lamports:   LAMPORTS_PER_EDDA, // 1 EDDA
  }));
  tx.sign(alice);
